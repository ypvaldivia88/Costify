...
import type { ExchangeRateSettings, ExchangeRateSnapshot } from '@/lib/domain/exchange-rates';
import {
  fromCup,
  getPriceReviewAlerts,
  PURCHASE_CURRENCY_LABELS,
} from '@/lib/domain/exchange-rates';
import type { ProductCalculation, PurchaseCurrency, RawMaterial } from '@/lib/domain/types';
...
export function usePriceReviewAlerts(
  materials: RawMaterial[],
  products: ProductCalculation[]
) {
