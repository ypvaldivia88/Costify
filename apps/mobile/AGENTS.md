...
**Prioridad móvil:** registro, suscripciones y aprobaciones de super admin viven en la app nativa (`RegisterScreen`, `SubscriptionPanel`, `AdminScreen`). La web replica los mismos flujos.
