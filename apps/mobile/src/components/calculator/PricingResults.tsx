...
import type { ProductCalculation, RawMaterial, TaxSettings } from '@costify/shared/domain/types';
import {
  getIndirectCoverage,
...
import { DISTRIBUTION_CRITERIA_SHORT, MARGIN_TYPE_LABELS } from '@costify/shared/domain/constants';
...
const styles = StyleSheet.create({
  ...
  rowLabel: { flex: 1, fontSize: 13, minWidth: 0 },
  rowValue: { fontSize: 13, fontWeight: '700', flexShrink: 0, textAlign: 'right' },
